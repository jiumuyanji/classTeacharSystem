...
import kotlinx.android.synthetic.main.activity_classactivity.*

class ClassactivityActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_classactivity)
        val dbHelper=MyDatabaseHelper(this,"class.db",1)
        val db=dbHelper.writableDatabase
        val cursor=db.query("classActivity",null,null,null,null,null,null)
        ...
        list2.setOnItemClickListener { _, _, position, _ ->
            ...
            val intent= Intent(this,ReadactivityActivity::class.java)
        ...
        add.setOnClickListener {
            val intent = Intent(this, WriteactivityActivity::class.java)
            startActivity(intent)
            finish()
        }

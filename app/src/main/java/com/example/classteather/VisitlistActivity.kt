...
import kotlinx.android.synthetic.main.activity_visitlist.*
...
class VisitlistActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cursor=db.query("visit",null,"id=?",arrayOf(extraId.toString()),null,null,null)
        ...
        list2.setOnItemClickListener { _, _, position, _ ->
            ...
            val intent= Intent(this,ReadvisitActivity::class.java)
        ...
        add.setOnClickListener {
            val intent = Intent(this, WritevisitActivity::class.java)
            intent.putExtra("extra_id",extraId.toString())
            intent.putExtra("extra_name",extraName.toString())
            startActivity(intent)
            finish()
    ...
    override fun onRestart() {
        ...
        val dbHelper=MyDatabaseHelper(this,"class.db",1)
        val db=dbHelper.writableDatabase
        val cursor=db.query("visit",null,"id=?", arrayOf(extraData),null,null,null)
        val visitList= ArrayList<String>()

...
import kotlinx.android.synthetic.main.activity_writeworksummary.*

class WriteworksummaryActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_writeworksummary)
        ...
        save.setOnClickListener {
            ...
            db.insert("workSummary",null,values1)

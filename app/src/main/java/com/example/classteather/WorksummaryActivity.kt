...
import kotlinx.android.synthetic.main.activity_worksummary.*
...
class WorksummaryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cursor=db.query("workSummary",null,null,null,null,null,null)
        ...
        list2.setOnItemClickListener { _, _, position, _ ->
            ...
            val intent= Intent(this,ReadworksummaryActivity::class.java)
        ...
        add.setOnClickListener {
            val intent = Intent(this, WriteworksummaryActivity::class.java)
            startActivity(intent)
            finish()
        }

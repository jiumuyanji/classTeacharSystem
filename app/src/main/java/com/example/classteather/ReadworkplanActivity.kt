...
import kotlinx.android.synthetic.main.activity_readworkplan.*

class ReadworkplanActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_readworkplan)
        ...
        delete.setOnClickListener {
            AlertDialog.Builder(this).apply {
                ...
                setPositiveButton("ok"){_, _->
                    db.delete("workPlan","title = ? and time = ?", arrayOf(extraTitle.toString(),extraTime.toString()))
                }
        ...
        update.setOnClickListener {
            ...
            db.update("workPlan",values1,"title = ? and time = ?", arrayOf(extraTitle.toString(),extraTime.toString()))
